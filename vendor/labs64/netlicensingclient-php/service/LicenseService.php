...
class LicenseService
{
     ...
     */
    public static function create(Context $context, $licenseeNumber, $licenseTemplateNumber, $transactionNumber, License $license)
    {
     ...
     * @throws RestException
     */
    public static function getList(Context $context, $filter)
    {
     ...
     * @throws \ErrorException
     */
    public static function update(Context $context, $number, $transactionNumber, License $license)
    {
        CheckUtils::paramNotEmpty($number, Constants::NUMBER);
     ...
     * @throws \ErrorException
     */
    public static function delete(Context $context, $number, $forceCascade)
    {
        CheckUtils::paramNotEmpty($number, Constants::NUMBER);
