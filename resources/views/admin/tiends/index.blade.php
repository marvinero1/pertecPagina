...
<div class="container">
    <div class="row">
        <div class="title_left" style="text-align: center;">
            <h3>{{ __('views.admin.tiends.index.title') }} </h3>
        </div><br>
            ...
            <div class="x_panel">
                ...
                <div class="x_content table-responsive">
                    <table class="table" >
                        ...
                        <tbody>
                            @foreach($tienda as $tiends)
                            <tr>
                                <td scope="row">{{ $tiends->nombre_tienda }}</td>
                                <td scope="row">{{ $tiends->telefono }}</td>
                                <td scope="row">{{ $tiends->celular }}</td>
                                ...
                                <td scope="row" style="text-align:center;">
                                    <a href="{{ route('admin.tienda.show', $tiends->id ) }}" style="color: black">
                                        <button class="btn btn-gray"><i class="fa fa-eye" aria-hidden="true"></i>
                                            Ver</button></a>                                      

                                    <form action="{{ route('admin.tienda.destroy', $tiends->id ) }}" method="POST"
