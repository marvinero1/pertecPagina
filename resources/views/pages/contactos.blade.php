                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8">
                        <div class="row">
                            <form id="contact-form" action="#" method="post">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <input type="text" class="form-control mb-30" name="contact-telephone"
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control mb-30" name="contact-message" id="message" rows="3"
                                        placeholder="Mensaje" required></textarea>
                                </div>
                                <div class="col-md-12">
                                    <button type="submit" id="submit-message"
                                        class="btn btn-primary btn-black btn-block">Enviar Mensaje</button>
                                </div>
