            ...
            <tr style="border-collapse:collapse">
                <td valign="top" style="padding:0;Margin:0">
                    <table cellpadding="0" cellspacing="0" class="es-content" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td class="es-adaptive" style="padding:0;Margin:0;background-color:#093070"
                                bgcolor="#093070" align="center">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="right" class="es-infoblock es-m-txt-c"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:14px;color:#CCCCCC;font-size:12px">
                                                                        <a href="https://www.pertec.com.bo" class="view"
                                                                            target="_blank"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-c" align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Recibimos una solicitud de confirmación de
                                                                        correo electrónico
                                                                        en <a
                                                                            href="https://www.pertec.com.bo">www.pertec.com.bo</a>,
                                                                        si esto es
                                                                        correcto, por favor confirme haciendo clic en el
                                                                        botón de abajo.
                                                                        Si usted no sabe porqué recibió este correo
                                                                        electrónico,
                                                                        puede comunicarse de inmediato con nosotros.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                    ...
                    <table cellpadding="0" cellspacing="0" class="es-footer" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;background-color:#093070" bgcolor="#093070" align="center">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                                    ...
                                                                    <table class="es-table-not-adapt es-social"
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td valign="top" align="center"
                                                                                ...
                                                                                <a href="#" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:14px">
                                                                                    <i style="font-size: 2rem;" title="Facebook" class="fa fa-facebook-official" aria-hidden="true"></i>
                                                                                </a>
                                                                            </td>
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0;padding-right:20px">
                                                                                <a href="https://www.pertec.com.bo" target="_blank"
                                                                                    ...
                                                                                    <i style="font-size: 2rem;" title="Sitio Web" class="fa fa-share-square-o" aria-hidden="true"></i>
                                                                                </a>
                                                                            </td>
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0">
                                                                                <a href="https://wa.me/+59172221032/?text=Hola%20Pertec%20Quisiera%20Cotizar%20Sus%20Productos" target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:14px">
                                                                                    <i style="font-size: 2rem;" class="fa fa-whatsapp" title="Whatsapp" aria-hidden="true"></i>
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0;padding-bottom:10px">
                                                                    <br>                                                                    <label class="font-frank-medium label1"> PERTEC SRL
                                                                    </label>
                                                                    <label class="font-frank-book label1">Copyright
                                                                        &copy; </label>
                                                                    <label id="yearcopy"
                                                                        class="font-frank-book label1">. </label>
                                                                    <label class="font-frank-book label1"> Todos los
                                                                        derechos reservados.</label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
