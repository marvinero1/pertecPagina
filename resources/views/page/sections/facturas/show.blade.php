                        ...
                        <div style="padding: 25px;">
                            ...
                            <div class="row">
                                <div class="col-md-2" style="padding-right: 0px;">
                                    <h6 class="font-frank-demi color-black"
                                        style="margin-bottom: 8px; line-height: 17px;">Lugar y Fecha :</h6>
                                    <h6 class="font-frank-demi color-black"
                                        style="margin-bottom: 8px; line-height: 17px;">Nom/Razon Social :</h6>
                                </div>
                                <div class="col-md-6" style="padding-left: 0px; margin: 0 30px 0 -30px;">
                                    <h6 class="font-frank-book color-black"
                                        style="margin-bottom: 8px; line-height: 17px;">SACABA,
                                        {{ date('d-m-y', strtotime($verfactura->fecha)) }} Hrs.
                                        {{ $verfactura->horareg }}</h6>
                                    <h6 class="font-frank-book color-black"
                                        style="margin-bottom: 8px; line-height: 17px;">{{ $verfactura->nomcliente }}
                                    </h6>
                                </div>
                                <div class="col-md-2" style="text-align: right;">
                                    <h6 class="font-frank-demi color-black"
                                        style="margin-bottom: 8px; line-height: 17px;">Nit/Ci/Cex :</h6>
                                    <h6 class="font-frank-demi color-black"
                                        style="margin-bottom: 8px; line-height: 17px;">Código Cliente :</h6>
                                </div>
                                <div class="col-md-2" style="padding-left: 0px;">
                                    <h6 class="font-frank-book color-black"
                                        style="margin-bottom: 8px; line-height: 17px;">{{ $verfactura->nit }} </h6>
                                    <h6 class="font-frank-book color-black"
                                        style="margin-bottom: 8px; line-height: 17px;">{{ $verfactura->nit }}</h6>
                                </div>
                            </div>
                            ...
                            <div class="row" style="text-align: -webkit-center;">
                                ...
                                <div class="col-md-4"><br>
                                    ...
                                    !!}
                                    {{-- <img src="data:image/png;base64, {{ base64_encode(QrCode::size(100)->generate('https://pilotosiat.impuestos.gob.bo/consulta/QR?nit='.$verfactura->nit.'&cuf='.$verfactura->nroautorizacion.'&numero='.$verfactura->nrofactura.'&t=2')) }}
                                    "> --}}
                                </div>
                            </div>
                        </div>
