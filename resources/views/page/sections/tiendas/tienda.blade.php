        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 shop-content">
                <div class="product-img product-feature-img mb-50">
                    <img src="http://192.168.31.242:5000/{{ $tienda->['imagen'] }}" alt="product" />
                </div>
            </div>
                                ...
                                <table class="table table-striped">
                                    <tbody>
                                        <tr style="text-transform: uppercase;">
                                            <td>Encargado</td><td>{{ $tienda->["encargado"] }}</td>
                                        </tr>
                                        <tr style="text-transform: uppercase;">
                                            <td>Celular</td><td>{{ $tienda->["celular"] }}</td>
                                        </tr>
                                        <tr style="text-transform: uppercase;">
                                            <td>Whatsapp</td><td>{{ $tienda->["whatsapp"] }}</td>
                                        </tr>
                                        <tr style="text-transform: uppercase;">
                                            <td>Teléfono</td><td>{{ $tienda->["telefono"] }}</td>
                                        </tr>
                                        <tr style="text-transform: uppercase;">
                                            <td>Correo Electrónico</td><td>{{ $tienda->["correo_electronico"] }}</td>
                                        </tr>
                                        <tr style="text-transform: uppercase;">
                                            <td>Dirección</td><td>{{ $tienda->["direccion"] }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
