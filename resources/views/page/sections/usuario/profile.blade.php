            ...
            <div class="row">
                <div class="col-6 col-sm-4 col-md-4 col-lg-4">
                    <div class="count-data text-center">
                        <h6 class="count h2" data-to="500" data-speed="500"><i class="fa fa-handshake-o" aria-hidden="true"></i>  {{ $counts['pedidos'] }}</h6>
                        <p class="m-0px font-w-600 text-center"><a href="/mis_pedidos"> Pedidos Realizados</a></p> 
                    </div>
                </div>
                <div class="col-6 col-sm-4 col-md-4 col-lg-4">
                    <div class="count-data text-center">
                        <h6 class="count h2" data-to="150" data-speed="150"><i class="fa fa-inbox" aria-hidden="true"></i> {{ $counts['facturas'] }}</h6>
