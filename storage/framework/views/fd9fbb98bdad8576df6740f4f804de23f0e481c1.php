        ...
        <div class="row" style="border: outset;"><br>
            ...
            <div class="col-md-12 col-sm-12" style="padding-block-end: 7px;">
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <select id="linea" name="linea" class="form-control" value="<?php echo e($producto->linea); ?>" required>
                        <option>Elige</option>
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <select id="categoria" name="categoria" class="form-control" value="<?php echo e($producto->categoria); ?>" required>
                        <option>Elige</option>
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <select id="sub_categoria" name="sub_categoria" class="form-control" value="<?php echo e($producto->sub_categoria); ?>" required>
                        <option>Elige</option>
