    ...
    <table class="minimalistBlack alineacion">
        <tbody>
            <tr>
                ...
                <td rowspan="3" style="text-align: center;">
                    <h6 class="font-frank-demi color-black" style="font-size: 0.8rem; line-height: 0px; margin: 0;">
                        FACTURA
                    </h6><br>
                    <h6 class="font-frank-demi color-black" style="margin-top: 2px;">CON DERECHO A CREDITO FISCAL</h6>
                </td>
...
<?php /**PATH C:\laragon\www\pertecPagina\resources\views/page/sections/facturas/pruebas.blade.php ENDPATH**/ ?>