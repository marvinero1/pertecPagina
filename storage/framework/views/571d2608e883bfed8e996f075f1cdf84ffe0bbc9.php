    ...
    <div class="left_col scroll-view">
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li>
                        <a href="<?php echo e(route('admin.pop-up.index')); ?>">
                            <i class="fa fa-wpexplorer" aria-hidden="true"></i>
                            <?php echo e(__('views.backend.section.navigation.menu_1_14')); ?>
...
<?php /**PATH C:\laragon\www\repoCompletoPertec\pertecPagina\resources\views/admin/sections/navigation.blade.php ENDPATH**/ ?>