		...
		<div class="row">
			<div class="container">
				...
				<div class="navbar-header" >
					...
					<a class="logo" href="/">
						<img src="assets/images/icon.png" alt="Pertec S.R.L" style="height: -webkit-fill-available;" >
					</a>
				</div>
				...
				<div class="collapse navbar-collapse pull-right" id="bs-example-navbar-collapse-1" >
                    ...
                    <div class="module module-search pull-left">
                        <div class="search-icon">
                            <img src="assets/images/system/LUPA.png" width="20px;">
                    ...
                    <div class="module module-search pull-right">
                        <div class="search-icon user-icon-margin">
                            <img src="/assets/images/system/USER.png" width="40px;">
