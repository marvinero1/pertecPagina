<div class="container p-1">
    <div class="row" style="text-align: center; height: 170px;">
        ...
        <div class="col-md-2" style="text-align: right;">
            ...
            <h6 class="font-frank-demi color-black" style="margin-bottom: 5px;">Factura Nro:
            </h6>
            <h6 class="font-frank-demi color-black" style="margin-bottom: 5px;">Cód
                Autorización: </h6>
        </div>
    ...
    <div class="row">
        <div class="col-md-2" style="padding-right: 0px;">
            <h6 class="font-frank-demi color-black" style="margin-bottom: 8px; line-height: 17px;">Lugar y
                Fecha :</h6>
            <h6 class="font-frank-demi color-black" style="margin-bottom: 8px; line-height: 17px;">Nom/Razon
                Social :</h6>
        </div>
        <div class="col-md-6" style="padding-left: 0px; margin: 0 30px 0 -30px;">
            <h6 class="font-frank-book color-black" style="margin-bottom: 8px; line-height: 17px;">SACABA,
                31/5/2022 Hrs. 16:54</h6>
            <h6 class="font-frank-book color-black" style="margin-bottom: 8px; line-height: 17px;">ALVARO
                BENJAMIN MERINO VELARDE
            </h6>
        </div>
        <div class="col-md-2" style="text-align: right;">
            <h6 class="font-frank-demi color-black" style="margin-bottom: 8px; line-height: 17px;">
                Nit/Ci/Cex :</h6>
            <h6 class="font-frank-demi color-black" style="margin-bottom: 8px; line-height: 17px;">Código
                Cliente :</h6>
        </div>
        <div class="col-md-2" style="padding-left: 0px;">
            <h6 class="font-frank-book color-black" style="margin-bottom: 8px; line-height: 17px;">
                8021631019</h6>
            <h6 class="font-frank-book color-black" style="margin-bottom: 8px; line-height: 17px;">
                8021631019</h6>
        </div>
    ...
    <div class="row" style="text-align: -webkit-center;">
        <div class="col-md-8" style="padding: 0px 40px 0px 40px;">
            ...
            <P class="infoFactura">
                Ley N° 453: Está prohibido importar, distribuir o comercializar productos
                prohibidos o retirados en el
        ...
        <div class="col-md-4">
            <br>
            <img src="https://qrcode.tec-it.com/API/QRCode?data=smsto%3A555-555-5555%3AGenerador+de+Códigos+QR+de+TEC-IT"
                alt="qrCode" width="120px">
        </div>
    </div>
