    ...
    <div class="row">
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                <td><?php echo e($user->last_login); ?> (<?php echo e($user->last_login->diffForHumans()); ?>)</td>
            </tr>
            </tbody>
        </table>
    </div>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pertec\resources\views/admin/users/show.blade.php ENDPATH**/ ?>