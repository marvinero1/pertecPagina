...
<!-- page content -->
    <div class="row">
        <div class="title_left" style="text-align: center;">
            <h3><?php echo e(__('views.admin.products.index.title')); ?> en Promocion</h3>
        </div><br>
                            ...
                            <div class="thumbnail">
                                ...
                                <div class="caption">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Descripcion Promoción</label>
                                        <textarea disabled="true" class="form-control" id="exampleFormControlTextarea1"
                                            rows="3" placeholder="<?php echo e($productos->descripcion_promocion); ?>"></textarea>
                                    </div>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\repoCompletoPertec\pertecPagina\resources\views/admin/products/promocion.blade.php ENDPATH**/ ?>