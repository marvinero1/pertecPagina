                                ...
                                <tr>
                                    ...
                                    <td scope="row" style="text-align:center;">
                                        ...
                                        <?php if($productos->promocion !='si'): ?>
                                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal<?php echo e($productos->id); ?>">
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\repoCompletoPertec\pertecPagina\resources\views/admin/products/index.blade.php ENDPATH**/ ?>