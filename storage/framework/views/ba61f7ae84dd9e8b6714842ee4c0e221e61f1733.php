...
<section class="section about-section gray-bg" id="about" style="padding-top: 180px">
    <div class="content section-content"><br><br>
            ...
            <div class="row">
                <div class="col-6 col-sm-4 col-md-4 col-lg-4">
                    <div class="count-data text-center">
                        <h6 class="count h2" data-to="500" data-speed="500"><i class="fa fa-handshake-o" aria-hidden="true"></i>  <?php echo e($counts['pedidos']); ?></h6>
                        <p class="m-0px font-w-600 text-center"><a href="/mis_pedidos"> Pedidos Realizados</a></p> 
                    </div>
                </div>
                <div class="col-6 col-sm-4 col-md-4 col-lg-4">
                    <div class="count-data text-center">
                        <h6 class="count h2" data-to="150" data-speed="150"><i class="fa fa-inbox" aria-hidden="true"></i> <?php echo e($counts['facturas']); ?></h6>
                        <p class="m-0px font-w-600 text-center"><a href="/invoices"> Facturaciones Realizadas</a></p> 
                    </div>
                </div>
                <div class="col-6 col-sm-4 col-md-4 col-lg-4">
                    <div class="count-data text-center">
                        <h6 class="count h2" data-to="0" data-speed="850">0</h6>
                        <p class="m-0px font-w-600 text-center"><a href="">Cotizaciones Realizados</a></p> 
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog-register">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="font-title-user-mod modal-title text-center font-title-user-mod"><?php echo e(__('views.auth.update.header')); ?></h4>
            </div>
            <div class="modal-body" style="padding: 0px 45px 0px !important; margin-top: 27px;">
                <div class="login_wrapper">
                    <div class="animate form body-details" style="padding: 0px 0px 54px 0px !important;">
                        <form action="<?php echo e(route('users.update', $user_id->id)); ?>" method="POST">
                            ...
                            <div>
                                <input type="text" name="name" class="form-control body-details"
                                        placeholder="<?php echo e($user_id->name); ?>" required autofocus/>
                            </div>
                            <div>
                                <input type="text" name="apellido" class="form-control"
                                    placeholder="<?php echo e($user_id->apellido); ?>" required autofocus/>
                            </div>
                            <div>
                                ...
                                <select id="<?php echo e(__('views.auth.update.input_5')); ?>" name="ciudad" class="form-control form-group"
                                 required autofocus>
                                    <option value="<?php echo e($user_id->ciudad); ?>"><?php echo e($user_id->ciudad); ?></option>
                            ...
                            <div>
                                <input type="text" name="celular" class="form-control"
                                        placeholder="<?php echo e($user_id->celular); ?>" required autofocus/>
                            </div>
                            <div>
                            ...
                            <div>
                                <input type="email" name="email" class="form-control"
                                        placeholder="<?php echo e($user_id->email); ?>" required hidden="true"/>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="rol" value="<?php echo e($user_id->rol); ?>" hidden="true">
                            </div>
...
<?php echo $__env->make('page.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\repoCompletoPertec\pertecPagina\resources\views/page/sections/usuario/profile.blade.php ENDPATH**/ ?>