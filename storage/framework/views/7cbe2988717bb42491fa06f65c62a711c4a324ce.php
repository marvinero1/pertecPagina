            ...
            <div class="card card-price">
                <div class="card-img"><br>
                    ...
                    <div class="cat" style="text-align: center;"><br>
                        <div class="col">
                            <div class="row">
                                <div id="lat" hidden="true"><?php echo e($tienda->latitud); ?></div> <div id="long" hidden="true"><?php echo e($tienda->longitud); ?></div>
                            </div>
                        </div>
                    </div>
                    <div id="map"></div>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\repoCompletoPertec\pertecPagina\resources\views/admin/tiends/show.blade.php ENDPATH**/ ?>