            ...
            <div class="col-md-12 col-sm-12" style="padding-block-end: 7px;">
                ...
                <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <select id="ciudad" name="ciudad" class="form-control"  required>
                        <option value="<?php echo e($tienda->ciudad); ?>"><?php echo e($tienda->ciudad); ?></option>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pertecPagina\resources\views/admin/tiends/edit.blade.php ENDPATH**/ ?>