html , body{
 ...
 background: linear-gradient(36deg, rgba(255,254,4,0.6460959383753502) 0%, rgba(40,50,161,1) 36%);
}
.full-width {
 width:100%;
}
...
body {
    ...
    /* background: #2832A1; */
    background: rgb(255,254,4);
background: linear-gradient(36deg, rgba(255,254,4,0.8673844537815126) 4%, rgba(40,50,161,0.9822303921568627) 26%);
...
.nav.side-menu>li.active>a {
    ...
    background: linear-gradient(#334556, #2C4257), #2832A1;
